...
void uart0_eventHandler() {
    ...
    uint16_t data = (uint16_t) UART0_GetByte();
    
    // handle events variable: only clear if uart rx buff is empty
    if (UART0_GetRxBufferSize() == 0) {
        events &= ~EVENT_UART0;
    }
    ...
    case lwhi:
        ...
        Drive_WriteCompare1(DrivePayload.leftWheels);
        driveState = rwlo;
        break;
    case rwlo:
    ...
    case rwhi:
        ...
        Drive_WriteCompare2(DrivePayload.rightWheels);
        driveState = panlo;
        break;
    case panlo:
    ...
    case panhi:
        ...
        Gimbal_WriteCompare1(DrivePayload.cameraPan);
        driveState = tiltlo;
        break;
    case tiltlo:
    ...
    case tilthi:
        ...
        Gimbal_WriteCompare2(DrivePayload.cameraTilt);
